...
import {
  ...
  CoinIcon3,
  CoinIcon4,
} from "../zenix/Transactions/TableData";
import TestTable from "../table/SortingTable/TestTable";
  ...
  return (
    <Fragment>
      <div className="form-head mb-sm-5 mb-3 d-flex align-items-center flex-wrap">
        <h2 className="font-w600 mb-0 me-auto mb-2 text-black">My Strategy</h2>
      ...
      <div className="card-action coin-tabs my-3 mt-sm-0">
        <Nav as="ul" className="nav nav-tabs" role="tablist">
          ...
          <Nav.Item as="li">
            <Nav.Link to={"#"} eventKey="David">
              <CoinIcon3 />
            </Nav.Link>
          </Nav.Item>
          <Nav.Item as="li">
            <Nav.Link to={"#"} eventKey="Eth">
              <CoinIcon2 />
            </Nav.Link>
          </Nav.Item>
          <Nav.Item as="li">
            <Nav.Link to={"#"} eventKey="Ripple">
              <CoinIcon1 />
            </Nav.Link>
          </Nav.Item>
        </Nav>
            ...
            <div className="col-xl-12">
              <div className="d-block d-sm-flex mb-4">
                ...
                <div className="d-flex mt-sm-0">
                  <Link to={"#"} className="btn-link me-3 underline">
                    Generate Number
                  </Link>
