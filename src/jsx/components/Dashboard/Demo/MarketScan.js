...
import Widget1 from "../../zenix/Home/WidgetChart1";
import Widget2 from "../../zenix/Home/WidgetChart2";
import Widget3 from "../../zenix/Home/WidgetChart3";
import Widget4 from "../../zenix/Home/WidgetChart4";
          ...
          <div className="col-sm-6">
            <div className="card">
              <div className="card-header border-0 pb-0">
                <h4 className="mb-0 text-black fs-20">Highest Return</h4>
              ...
              <div className="card-body p-3">
                <div className="card-action card-tabs style-4 my-3 mt-sm-0">
